...
type WooResponse={ok:boolean;count?:number;products?:WooProduct[];error?:string};
...
export default function WooCommerceAdminPage(){
  ...
  return <main className="woo-admin"><style>{css}</style>
    <header className="woo-head"><div><p>Connexion boutique</p><h1>WooCommerce</h1><span>Lecture sécurisée de la boutique existante. Rien n’est modifié ici pour l’instant.</span></div><button onClick={load} disabled={loading}>{loading?'Actualisation…':'↻ Actualiser'}</button></header>
