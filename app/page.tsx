  ...
  return (
    <main className="page">
      ...
      <footer className="footer">
        <div className="footer-brand">Com’ entre nous <span>♥</span></div>
