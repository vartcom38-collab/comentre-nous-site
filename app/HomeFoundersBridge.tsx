  ...
  useEffect(()=>{
    ...
    section.innerHTML=`
      ...
      <div class="home-founders-side">
        <img class="home-founders-photo" src="/uploads/marion-aurelie-home-crisp.webp?v=14" alt="Marion et Aurélie, fondatrices de Com’ entre nous" />
    ...
    if(!document.getElementById('home-founders-style')){
      ...
      style.textContent=`
        ...
        .home-page .home-founders-side{position:relative;min-height:330px;border-radius:2rem;overflow:hidden;background:#fff;box-shadow:0 18px 45px rgba(48,30,18,.12);aspect-ratio:4/3;width:100%;max-width:610px;justify-self:end}
