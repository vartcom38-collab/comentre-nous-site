  ...
  useEffect(()=>{
    ...
    section.innerHTML=`
      ...
      <div class="home-founders-side">
        <img class="home-founders-photo" src="/uploads/marion-aurelie-home-crisp.webp?v=11" alt="Marion et Aurélie, fondatrices de Com’ entre nous" />
    ...
    if(!document.getElementById('home-founders-style')){
      ...
      style.textContent=`
        ...
        .home-page .home-founders-side{position:relative;min-height:330px;border-radius:2rem;overflow:hidden;background:#fff;box-shadow:0 18px 45px rgba(48,30,18,.12);aspect-ratio:4/3;width:100%;max-width:650px;justify-self:end}
        ...
        @media(max-width:820px){.home-page .home-founders-block{grid-template-columns:1fr}.home-page .home-founders-side{min-height:0;aspect-ratio:4/3;max-width:none;justify-self:stretch}.home-page .home-founders-note h2{font-size:3.5rem}}
      `;
