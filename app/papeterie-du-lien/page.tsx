...
export default function PaperPage() {
  ...
  const page = siteContent.pages.papeterie;
  return <LayoutShell><main><PageIntro kicker={page.kicker} title={page.title} text={page.intro} /><section className="content-card"><h2>{page.blockTitle}</h2><p>{page.blockText}</p></section><section className="section"><div className="section-title"><h2>{page.productsTitle}</h2></div><ProductGrid items={items} /></section><Newsletter /></main></LayoutShell>;
}
