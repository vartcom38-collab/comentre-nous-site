    ...
    <LayoutShell>
      <main className="entre-page">
        ...
        <section className="entre-hero">
          ...
          <div className="entre-hero-visual" aria-label="Emplacement de la future photo Com des entrepreneuses">
            <div className="entre-photo-placeholder">
              <span>Photo entrepreneuse</span>
              <small>On mettra ici la photo que nous allons générer ensemble.</small>
            </div>
          </div>
        </section>
        ...
        <section className="entre-intro-shop">
          <div>
            <p className="entre-eyebrow">Des supports qui servent vraiment</p>
            <h2>Des idées, de la clarté, et des outils pour avancer.</h2>
          </div>
          <p>On commence avec <strong>Comme un murmure</strong>, puis la boutique pourra accueillir d’autres oracles, carnets, ressources numériques et supports pour entrepreneuses au fil des créations.</p>
        </section>
