      ...
      <main className="product-page-rich">
        <section className="product-hero-rich">
          ...
          <div className="product-info-rich">
            ...
            {product.badge && <span className="product-badge-rich">{product.badge}</span>}
            <h1>{product.title}</h1>
            ...
            {product.buyUrl ? <a className="dark-btn" href={product.buyUrl}>{product.buyLabel || 'Acheter'} →</a> : <span className="dark-btn disabled-buy">Bientôt disponible</span>}
          </div>
        </section>

        {(product.longDescription || product.highlights?.length || product.included?.length) && <section className="product-content-rich">
...
const css = `.product-page-rich{width:min(1400px,calc(100% - 2rem));margin:auto;padding:clamp(2rem,5vw,5rem) 0}.product-hero-rich{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(360px,.82fr);gap:clamp(2rem,5vw,5rem);align-items:start}.product-main-rich{aspect-ratio:4/3;border-radius:34px;overflow:hidden;display:grid;place-items:center;padding:30px;text-align:center;box-shadow:0 24px 70px rgba(48,30,18,.1)}.product-main-rich img{width:100%;height:100%;object-fit:cover}.product-main-rich span{font-size:13px;text-transform:uppercase;font-weight:900}.product-main-rich strong{font:700 clamp(42px,5vw,72px)/.9 'Patrick Hand',cursive}.product-main-rich.coral{background:#ffe0da}.product-main-rich.mint{background:#d9f5ef}.product-main-rich.lilac{background:#ead9ff}.product-main-rich.yellow{background:#ffedb6}.product-main-rich.blue{background:#dcecff}.product-thumbs-rich{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:10px}.product-thumbs-rich img{width:100%;aspect-ratio:1;object-fit:cover;border-radius:14px}.product-info-rich{position:sticky;top:110px}.product-info-rich h1{margin:.4rem 0 .8rem;font:700 clamp(48px,6vw,84px)/.88 'Patrick Hand',cursive}.product-tagline-rich{font-size:20px;font-weight:800;line-height:1.4}.product-badge-rich{display:inline-flex;padding:7px 10px;border-radius:999px;background:#ff5d62;color:white;font-size:11px;font-weight:900}.product-price-rich{display:flex;align-items:center;gap:12px;margin:20px 0}.product-price-rich strong{font-size:30px}.product-price-rich del{color:#8c8f9c}.product-meta-rich{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:22px 0}.product-meta-rich span{display:grid;gap:4px;padding:12px;border-radius:14px;background:#fff;box-shadow:0 10px 30px rgba(48,30,18,.05);font-size:12px}.product-meta-rich b{font-size:10px;text-transform:uppercase;color:#777}.disabled-buy{opacity:.55;pointer-events:none}.product-content-rich{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;margin-top:70px}.product-content-rich article{background:#fff;padding:clamp(22px,3vw,38px);border-radius:28px;box-shadow:0 18px 55px rgba(48,30,18,.06)}.product-content-rich h2{margin:.3rem 0 1rem;font:700 clamp(34px,4vw,48px)/.95 'Patrick Hand',cursive}.product-content-rich p,.product-content-rich li{line-height:1.7}.product-content-rich ul{padding-left:1.2rem}.long-copy-rich{white-space:pre-line}.product-back-rich{margin:30px 0;font-weight:800}@media(max-width:900px){.product-hero-rich{grid-template-columns:1fr}.product-info-rich{position:static}.product-content-rich{grid-template-columns:1fr}.product-meta-rich{grid-template-columns:1fr 1fr}}@media(max-width:560px){.product-page-rich{width:calc(100% - 1rem);padding-top:1rem}.product-main-rich{border-radius:22px}.product-thumbs-rich{grid-template-columns:repeat(3,1fr)}.product-info-rich h1{font-size:48px}.product-tagline-rich{font-size:17px}.product-meta-rich{grid-template-columns:1fr}.product-content-rich{margin-top:35px}}`;
