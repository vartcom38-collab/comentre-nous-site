...
$stmt = $pdo->prepare('SELECT order_number, status, carrier, tracking_number, tracking_url, created_at, shipped_at FROM orders WHERE order_number = ? AND customer_email = ? LIMIT 1');
